        ...
        <div class="container-fluid flex-lg-column align-items-stretch">
            ...
            <div class="collapse navbar-collapse flex-column mt-2 align-items-stretch" id="adminDropdown">
                <ul class="list-unstyled">
                    <li class="mb-4">
                        <a class="btn btn-outline-light text-decoration-none w-100 mb-2" data-bs-toggle="collapse" href="#courseDropdown"  aria-expanded="false" aria-controls="multiCollapseExample1">Course</a>
                    ...
                    <li class="mb-4">
                        <a class="btn btn-outline-light text-decoration-none w-100 mb-2" data-bs-toggle="collapse" href="#userDropdown" aria-expanded="false" aria-controls="multiCollapseExample1">User</a>
